      ...
      <main>
        ...
        <section className="proof-section">
          <div className="container">
            ...
            <p className="positioning-line reveal">We are not a marketing agency. We are an operating partner responsible for outcomes across the full revenue chain.</p>
          </div>
        </section>
        ...
        <section id="pipeline" className="pipeline-section">
          <div className="container">
            <h2 className="section-title reveal">Click · Close · Collect</h2>

            {/* Pipeline Overview Cards */}
            <div className="pipeline-cards reveal-stagger">
            ...
            {/* Click */}
            <div className="pipeline-block reveal" data-number="01">
            ...
            {/* Close */}
            <div className="pipeline-block reveal" data-number="02">
            ...
            {/* Collect */}
            <div className="pipeline-block reveal" data-number="03">
        ...
        <section className="why-section">
          <div className="container">
            <h2 className="section-title reveal">Why SIG Solutions Exists</h2>

            <p className="reveal">SIG Solutions exists because internal teams struggle once volume increases.</p>

            <p className="emphasis-lines reveal">Leads are easy.<br />Sales pressure is not.<br />Collections are where most organisations quietly bleed.</p>

            <p className="reveal">We were built to run the uncomfortable middle:</p>
            ...
            <p className="why-conclusion reveal">Our role is simple.<br />We take responsibility where most organisations lose control.</p>
          </div>
        </section>
        ...
        <section className="who-section">
          <div className="container">
            <h2 className="section-title reveal">Who This Is For</h2>

            <div className="who-grid reveal-stagger">
        ...
        <section id="leadership" className="leadership-section">
          <div className="container">
            ...
            <div className="leadership-grid reveal-stagger">
            ...
            <p className="leadership-note reveal">Leadership is structured around responsibility, not titles.</p>
          </div>
        </section>
        ...
        <section id="engagement" className="engagement-section">
          <div className="container">
            <h2 className="section-title reveal">How Engagement Works</h2>

            <div className="engagement-grid reveal-stagger">
            ...
            <div className="engagement-performance reveal">
            ...
            <p className="engagement-note reveal">This is a working relationship, not a marketing retainer.</p>
          </div>
        </section>
        ...
        <section id="contact" className="contact-section">
          <div className="container">
            <h2 className="section-title reveal">Let's Talk Revenue Consistency</h2>

            <p className="contact-intro reveal">If you are evaluating partners, replacing internal strain, or fixing a broken revenue process, we'll tell you quickly whether we are a fit.</p>

            <p className="contact-principles reveal">No pitch decks.<br />No pressure.<br />Just a clear conversation.</p>
