      ...
      <Container>
        ...
        <div className="mx-auto grid max-w-4xl gap-8 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-green-200 bg-white p-8 lg:p-10"
          >
            ...
            <ul className="space-y-4">
              {FIT_ITEMS.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-green-50">
          ...
          >
            <h3 className="mb-6 font-heading text-xl font-bold text-slate-500">
              We are NOT a fit if
            </h3>
            <ul className="space-y-4">
